...
#if [[ -d $HOME/virtualenvs ]] || echo "Creating $HOME/virtualenvs directory to store all the virtual environments." ; mkdir $HOME/virtualenvs

if [[ ! -e $HOME/virtualenvs ]]; then
    echo "$HOME/virtualenvs doesn't exist, creating..."
    mkdir $HOME/virtualenvs
elif [[ ! -d $HOME/virtualenvs ]]; then
    echo "$HOME/virtualenvs already exists, skipped..."
fi
